...
from Utilities.AdditionalMethods import get_total_sum
from Utilities.TestData import TestData


@pytest.mark.parametrize('data_set', TestData.random_data_set(2))
...
def test_select_two_products(set_up, data_sets=TestData.random_data_set(2)):
    ...
    for data_set in data_sets:
        ...
        products_details[data_set["product_name"]] = data_set["product_price"] * (data_set["times"]+1)

    total_sum = get_total_sum(products_details)
    print(products_details)
    print(total_sum)

    main_page.enter_cart()\
             .assert_total_price_in_cart_is_correct(total_sum)\
             .go_to_final_buy_page()\
             .assert_total_price_in_final_page_is_correct(total_sum)
